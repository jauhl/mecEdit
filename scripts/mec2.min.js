 ...
 * @requires g2.js
 */
"use strict";mec.view={extend(t){if(t.type&&mec.view[t.type]){Object.setPrototypeOf(t,mec.view[t.type]);t.constructor()}return t}};mec.view.vector={constructor(){},init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},reset(){},asJSON(){return'{ "type":"'+this.type+'","id":"'+this.id+'","p":"'+this.p.id+'"'+(this.value?',"value":"'+this.value+'"':"")+" }"},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,10,mec.hoveredElmColor]:false},get endPoints(){const t=mec.aly[this.value].drwscl;const i=this.p[this.value];const s=Math.hypot(i.y,i.x);const e=!mec.isEps(s)?mec.asympClamp(t*s,25,100):0;return{p1:this.p,p2:{x:this.p.x+i.x/s*e,y:this.p.y+i.y/s*e}}},hitContour({x:t,y:i,eps:s}){const e=this.endPoints;return g2.isPntOnLin({x:t,y:i},e.p1,e.p2,s)},g2(){const t=this.endPoints;return g2().vec({x1:t.p1.x,y1:t.p1.y,x2:t.p2.x,y2:t.p2.y,ls:mec.color[this.value],lw:1.5,sh:this.sh})}};mec.view.trace={constructor(){},init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);this.pts=[];this.t0=0;this.model=t},dependsOn(t){return this.p===t},reset(){this.pts.length=0;this.t0=0},post(t){this.pts.push({x:this.p.x,y:this.p.y});if(this.model.timer.t-this.t0>this.Dt)this.pts.shift()},asJSON(){return'{ "type":"'+this.type+'","id":"'+this.id+'","p":"'+this.p.id+'"'+(this.Dt?',"Dt":'+this.Dt:"")+(this.stroke?',"stroke":"'+this.stroke+'"':"")+(this.fill?',"fill":"'+this.fill+'"':"")+" }"},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,10,mec.hoveredElmColor]:false},hitContour({x:t,y:i,eps:s}){return false},g2(){return g2().ply({pts:this.pts,format:"{x,y}",ls:this.stroke||"navy",lw:1.5,fs:this.fill||"transparent",sh:this.sh})}};mec.view.info={constructor(){},init(t){if(typeof this.elem==="string")this.elem=t.elementById(this.elem)},dependsOn(t){return this.elem===t},reset(){},asJSON(){return'{ "type":"'+this.type+'","id":"'+this.id+'","elem":"'+this.elem.id+'"'+(this.value?',"value":"'+this.value+'"':"")+(this.name?',"name":"'+this.name+'"':"")+" }"},get hasInfo(){return this.elem.state===g2.OVER},infoString(){if(this.value in this.elem){const t=this.elem[this.value];const i=mec.aly[this.value];const s=i.type;const e=t=>(t*i.scl).toPrecision(3);return(this.name||i.name||this.value)+": "+(s==="vec"?"{x:"+e(t.x)+",y:"+e(t.x)+"}":e(t))+" "+i.unit}return"?"}};
/**
 * mec.shape (c) 2018 Stefan Goessner
 * @license MIT License
 * @requires mec.core.js
