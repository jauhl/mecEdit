 ...
 * @requires g2.js
 */
"use strict";mec.node={extend(t){Object.setPrototypeOf(t,this.prototype);t.constructor();return t},prototype:{constructor(){this.x0=this.x;this.y0=this.y;this.xt=this.yt=0;this.xtt=this.ytt=0;this.dxt=this.dyt=0;this.Qx=this.Qy=0},validate(t){if(!this.id)return{mid:"E_ELEM_ID_MISSING",elemtype:"node",idx:t};if(this.model.elementById(this.id)!==this)return{mid:"E_ELEM_ID_AMBIGIOUS",id:this.id};if(typeof this.m==="number"&&mec.isEps(this.m))return{mid:"E_NODE_MASS_TOO_SMALL",id:this.id,m:this.m};return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.im=typeof this.m==="number"?1/this.m:this.base===true?0:1;Object.defineProperty(this,"m",{get:()=>1/this.im,set:t=>this.im=1/t,enumerable:true,configurable:true});Object.defineProperty(this,"base",{get:()=>this.im===0,set:t=>this.im=t?0:1,enumerable:true,configurable:true});this.radius=!!this.base?8:this.m>20?18:3.13874*Math.log(12.9244*this.m)},get xtcur(){return this.xt+this.dxt},get ytcur(){return this.yt+this.dyt},get type(){return"node"},get dof(){return this.m===Number.POSITIVE_INFINITY?0:2},get isSleeping(){return this.base||mec.isEps(this.xt,mec.velTol)&&mec.isEps(this.yt,mec.velTol)&&mec.isEps(this.xtt,mec.velTol/this.model.timer.dt)&&mec.isEps(this.ytt,mec.velTol/this.model.timer.dt)},get energy(){var t=0;if(!this.base){if(this.model.hasGravity)t+=this.m*(-(this.x-this.x0)*mec.from_m(this.model.gravity.x)-(this.y-this.y0)*mec.from_m(this.model.gravity.y));t+=.5*this.m*(this.xt**2+this.yt**2)}return t},dependsOn(t){return false},deepDependsOn(t){return t===this},reset(){if(!this.base){this.x=this.x0;this.y=this.y0}this.xt=this.yt=0;this.xtt=this.ytt=0;this.dxt=this.dyt=0},pre_0(){this.Qx=this.Qy=0;this.dxt=this.dyt=0},pre(t){if(!this.base&&this.model.hasGravity){this.Qx+=this.m*mec.from_m(this.model.gravity.x);this.Qy+=this.m*mec.from_m(this.model.gravity.y)}this.dxt+=this.Qx*this.im*t;this.dyt+=this.Qy*this.im*t;this.x+=(this.xt+1.5*this.dxt)*t;this.y+=(this.yt+1.5*this.dyt)*t},post(t){this.xt+=this.dxt;this.yt+=this.dyt;this.xtt=this.dxt/t;this.ytt=this.dyt/t},asJSON(){return'{ "id":"'+this.id+'","x":'+this.x0+',"y":'+this.y0+(this.base?',"base":true':"")+(!this.base&&this.m!==1?',"m":'+this.m:"")+(this.idloc?',"idloc":"'+this.idloc+'"':"")+" }"},get force(){return{x:this.Qx,y:this.Qy}},get pos(){return{x:this.x,y:this.y}},get vel(){return{x:this.xt,y:this.yt}},get acc(){return{x:this.xtt,y:this.ytt}},get forceAbs(){return Math.hypot(this.Qx,this.Qy)},get velAbs(){return Math.hypot(this.xt,this.yt)},get accAbs(){return Math.hypot(this.xtt,this.ytt)},get isSolid(){return true},get sh(){return this.state&g2.OVER?[0,0,10,this.model.env.show.hoveredElmColor]:this.state&g2.EDIT?[0,0,10,this.model.env.show.selectedElmColor]:false},_info(){return`x:${this.x}<br>y:${this.y}`},hitInner({x:t,y:i,eps:e}){return g2.isPntInCir({x:t,y:i},this,e)},selectBeg({x:t,y:i,t:e}){},selectEnd({x:t,y:i,t:e}){if(!this.base){this.xt=this.yt=this.xtt=this.ytt=0}},drag({x:t,y:i,mode:e}){if(e==="drag"&&!this.base){this.x=t;this.y=i}else if(e==="edit"){this.x0=this.x=t;this.y0=this.y=i}else return false},get r(){return this.model.env.show.nodeScaling?this.state&g2.OVER?1.5*this.radius:this.radius:mec.node.radius},g2(){let t=g2();if(this.model.env.show.nodes){const i=mec.node.locdir[this.idloc||"n"],e=this.x+(this.r+15)*i[0],s=this.y+(this.r+15)*i[1];t=this.base?g2().beg({x:this.x,y:this.y,sh:this.sh}).cir({x:0,y:0,r:this.r,ls:"@nodcolor",fs:"@nodfill"}).p().m({x:0,y:this.r}).a({dw:Math.PI/2,x:-this.r,y:0}).l({x:this.r,y:0}).a({dw:-Math.PI/2,x:0,y:-this.r}).z().fill({fs:"@nodcolor"}).end():g2().cir({x:this.x,y:this.y,r:this.r,ls:"#333",fs:"#eee",sh:this.sh});if(this.model.env.show.nodeLabels)t.txt({str:this.id||"?",x:e,y:s,thal:"center",tval:"middle",ls:this.model.env.show.txtColor})}return t}},radius:5,locdir:{e:[1,0],ne:[Math.SQRT2/2,Math.SQRT2/2],n:[0,1],nw:[-Math.SQRT2/2,Math.SQRT2/2],w:[-1,0],sw:[-Math.SQRT2/2,-Math.SQRT2/2],s:[0,-1],se:[Math.SQRT2/2,-Math.SQRT2/2]}};
/**
