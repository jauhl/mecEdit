...
g2.pntIterator = {
    "x,y": function(pts) { 
        ...
        Object.defineProperty(pitr, 'len', { get: () => pts.length/2, enumerable:true, configurable:true });
        return pitr; 
    },
    "[x,y]": function(pts) { 
        function pitr(i) { return {x:pts[i][0],y:pts[i][1]}; };
        Object.defineProperty(pitr, 'len', { get: () => pts.length, enumerable:true, configurable:true });
        return pitr; 
    },
    "{x,y}": function(pts) {
...
g2.pntItrOf = function(pts) {
   return !pts ? undefined
          : pts.length === 0 ? g2.pntIterator["{x,y}"](pts) 
