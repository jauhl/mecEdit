...
mecSlider.prototype = {
    ...
    revsym: '&#9665;',
    stopsym: '&#9744;',
    get html() { return `<div id="${this.id+'_rev'}" class="reverse badge badge-primary" style="cursor:pointer;">${this.revsym}</div>
...
<output class="badge badge-light ml-1" style="cursor:default;min-width:3.2rem;text-align:left;">${this.valstr(this.value)}</output>`
    },
//     get html() { return `<div id="${this.id+'_rev'}" class="reverse badge badge-primary" style="cursor:pointer;">${this.revsym}</div>
// <input type="range" class="custom-range" style="width:${this.width}px;" min="${this.min}" max="${this.max}" value="${this.value}" step="${this.step}" />
// <div id="${this.id+'_fwd'}" class="forward badge badge-primary" style="cursor:pointer;">${this.fwdsym}</div>
